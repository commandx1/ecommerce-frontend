...
export default function SupportCTASection() {
  return (
    <section
      id="support-cta"
      className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-steel-blue to-blue-800"
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg sm:text-xl text-blue-100 mb-8 sm:mb-12 leading-relaxed">
          Our logistics team is here to help with shipping questions, custom
          delivery arrangements, and bulk order coordination
        </p>
