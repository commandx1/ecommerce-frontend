...
const packagingItems = [
  ...
  },
  {
    ...
    description: "Special care for delicate dental instruments and equipment",
  },
  {
  ...
  },
  {
    ...
    description: "Clear handling instructions and hazard warnings where applicable",
  },
  {
    title: "Sustainability",
    description: "Recyclable and eco-friendly packaging materials whenever possible",
  },
]
...
export default function PackagingResponsibilitySection() {
  return (
    <section id="packaging-responsibility" className="py-12 sm:py-16 lg:py-20">
                ...
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-pale-lime rounded-full flex items-center justify-center mx-auto mb-4">
                  {item.label ? (
                    ...
                    (() => {
                      ...
                      return <Icon className="text-steel-blue w-6 h-6 sm:w-8 sm:h-8" />
                    })()
                  ) : null}
                </div>
