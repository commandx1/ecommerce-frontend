...
export default function ShippingMethodsComparison() {
  return (
    <section
      id="shipping-methods-comparison"
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[640px]">
              <thead className="bg-steel-blue text-white">
                <tr>
                  <th className="text-left p-4 sm:p-6 font-semibold text-sm sm:text-base">
                    Feature
                  </th>
              ...
              <tbody>
                <tr className="border-b border-gray-100">
                  <td className="p-4 sm:p-6 font-medium text-gray-700 text-sm sm:text-base">
                    Best For
                  </td>
                ...
                <tr className="border-b border-gray-100 bg-light-mint-gray/30">
                  ...
                  <td className="p-4 sm:p-6 text-center">
                    <div className="text-steel-blue font-semibold text-sm sm:text-base">
                      Same day
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-12">
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 leading-relaxed">
              For time-sensitive local deliveries within select metropolitan
              areas. Ideal for urgent supply needs and emergency orders.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <span className="text-sm sm:text-base text-gray-600">
                  Limited to orders under 50 lbs
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 leading-relaxed">
              Multi-carrier shipping platform supporting nationwide and
              international deliveries with comprehensive tracking and insurance
              options.
            </p>
            <div className="space-y-3">
              {[
