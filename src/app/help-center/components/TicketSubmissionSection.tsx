      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            For complex issues or detailed requests, submit a support ticket.
            Our technical team will provide comprehensive assistance with
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-steel-blue mb-2">
                  Quick Response
                </h3>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-steel-blue transition-colors">
                  ...
                  <p className="text-sm text-gray-500">
                    Screenshots, documents, or other relevant files (Max 25MB
                    total)
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>
                        • Be specific about error messages or unexpected
                        behavior
                      </li>
                      <li>
                        • Mention your browser/device if experiencing website
                        issues
                      </li>
                    </ul>
                  </div>
