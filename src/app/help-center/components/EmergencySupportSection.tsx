      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
            Need immediate assistance with a critical issue? Our emergency
            support line is available 24/7 for urgent matters that impact
            patient care.
          </p>
          ...
          <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-xl p-6 max-w-2xl mx-auto">
            <p className="text-orange-100 text-sm">
              <strong>Emergency support is reserved for:</strong> Equipment
              failures affecting patient care, critical order issues, payment
              processing emergencies, and system outages preventing essential
              operations.
            </p>
          </div>
        </div>
