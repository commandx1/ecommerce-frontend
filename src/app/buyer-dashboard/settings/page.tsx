...
import { AlertTriangle, Bell, Fingerprint, Lock, Mail, Phone, Save, Shield, Trash2, User } from "lucide-react"
...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-steel-blue">Account Settings</h1>
        <p className="text-gray-600 mt-2">Manage your professional profile and security preferences.</p>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-gray-900 font-medium font-mono">{user?.roleName || "Buyer"}</span>
              </div>
            </div>
          </div>

          <div className="bg-light-mint-gray rounded-2xl p-6">
            <h3 className="font-semibold text-steel-blue mb-2">Security Tip</h3>
            <p className="text-sm text-gray-700 leading-relaxed">
              Enable Two-Factor Authentication (2FA) to protect your account from unauthorized access. We recommend using an authenticator app.
            </p>
          </div>
        </div>
      </div>
