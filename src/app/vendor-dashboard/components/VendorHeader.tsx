        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="relative flex items-center gap-3" onClick={() => setShowMenu((prev) => !prev)}>
            ...
            <button type="button" className="text-gray-400 hover:text-steel-blue">
              <ChevronDown className="w-4 h-4 transition-transform duration-200" style={{ transform: showMenu ? "rotate(180deg)" : "rotate(0deg)" }} />
            </button>
            {showMenu && (
              <div
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center px-4 py-2 text-red-600 hover:bg-red-50 text-sm font-medium"
                >
