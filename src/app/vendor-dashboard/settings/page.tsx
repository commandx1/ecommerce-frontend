...
export default function VendorSettingsPage() {
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-steel-blue">Vendor Settings</h1>
        <p className="text-gray-600 mt-2">Manage your vendor profile and security preferences.</p>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-gray-900 font-medium font-mono">{user?.roleName || "Vendor"}</span>
              </div>
            </div>
          </div>

          <div className="bg-light-mint-gray rounded-2xl p-6">
            <h3 className="font-semibold text-steel-blue mb-2">Vendor Support</h3>
            <p className="text-sm text-gray-700 leading-relaxed">
              For any account-related inquiries or technical support, please contact your dedicated account manager or use our help center.
            </p>
          </div>
        </div>
      </div>
