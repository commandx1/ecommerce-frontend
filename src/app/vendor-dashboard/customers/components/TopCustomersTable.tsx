          ...
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id} className="border-t border-border-soft">
                ...
                <td className="px-6 py-4 text-text-primary">{customer.orders}</td>
                <td className="px-6 py-4 font-semibold text-text-primary">{formatCurrency(customer.totalSpend)}</td>
                <td className="px-6 py-4 text-text-primary">{formatCurrency(customer.averageOrderValue)}</td>
                <td className="px-6 py-4 text-text-primary">{customer.returnRate}%</td>
                <td className="px-6 py-4 text-text-secondary">{formatLastOrder(customer.lastOrderDaysAgo)}</td>
                <td className="px-6 py-4">
                  <span
                    className={cn(
