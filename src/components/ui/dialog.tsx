    ...
    return (
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            "fixed left-1/2 top-1/2 z-50 grid max-w-[calc(100%-2rem)] w-4xl -translate-x-1/2 -translate-y-1/2 gap-4 rounded-4xl border border-border-soft bg-surface-elevated p-0 shadow-floating duration-200",
            "data-[state=open]:animate-in data-[state=closed]:animate-out",
            "data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
